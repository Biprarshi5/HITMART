                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="sign-form">
                            <div class="sign-inner">
                                <div class="sign-logo" id="logo">
                                    <a href="index.jsp"><img src="images/HITLOGO.png" alt=""></a>
                                    <a href="index.jsp"><img class="logo-inverse" src="images/dark0.png" alt=""></a>
                                </div>
                                <div class="form-dt">
                        ...
                        <div class="copyright-text text-center mt-3">
                            Copyright <i class="uil uil-copyright"></i> 2020 <b>HIT SUPER MART</b>
                        </div>
                    </div>
                </div>
            </div>
