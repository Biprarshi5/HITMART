                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="about-step">
                                ...
                                <h4>400+</h4>
                                <p>People have joined the HIT Super Mart team in the past six months</p>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="about-step">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
							...
							<div class="item col-sm col-lg-3">
							    <div class="team-item">
							        <div class="team-img">
							            <img src="images/user/San.jpg" alt="">
							        </div>
							        <h4>Santanu Gope</h4>
							...
							<div class="item col-sm col-lg-3">
							    <div class="team-item">
							        <div class="team-img">
							            <img src="images/user/Avi.jpg" alt="">
							        </div>
							        <h4>Avishek Chatterjee</h4>
							        <span>Web Developer</span>
							        <ul class="team-social">
							            <li><a href="#" class="scl-btn hover-btn"><i class="fab fa-facebook-f"></i></a></li>
							            <li><a href="#" class="scl-btn hover-btn"><i class="fab fa-linkedin-in"></i></a></li>
							...
							<div class="item col-sm col-lg-3">
							    <div class="team-item">
							        <div class="team-img">
							            <img src="images/user/Bip.jpg" alt="">
							        </div>
							        <h4>Biprarshi Chowdhuri</h4>
							        <span>Web Developer</span>
							        <ul class="team-social">
							            <li><a href="#" class="scl-btn hover-btn"><i class="fab fa-facebook-f"></i></a></li>
							            <li><a href="#" class="scl-btn hover-btn"><i class="fab fa-linkedin-in"></i></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="default-title">
                                ...
                                <p>How Do I order on HIT Mart</p>
                                <img src="images/line.svg" alt="">
                            </div>
                        </div>
